...
namespace Alyabiev.Task08.Task1.Tests
{
	...
	public class DynamicArrayTests
	{
		...
		[Test]
		public void Remove_TwiceAtTheEndOfNormalArray_Good()
		{
			var na = GetNormalTestArray;
			var da = new DynamicArray<string>(na);
			int index = da.Length - 1;
			string expected = na[index - 2];
		...
		[Test]
		public void Remove_OnceOnNormalArray_LengthIsGood()
		{
			var da = new DynamicArray<string>(GetNormalTestArray);
		...
		[Test]
		public void Remove_TwiceOnNormalArray_LengthIsGood()
		{
			var da = new DynamicArray<string>(GetNormalTestArray);
			int expectedLength = da.Length - 2;
